...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
	...
	this.usuarios = [
    {nombre: 'Miren', apellido: 'Gurrutxurtu', correo: 'miren@cafe.com', contrasena: 'miren', foto: '../../assets/usuarios/miren.png'},
    {nombre: 'Pedro', apellido: 'Garcia', correo: 'pedro@cafe.com', contrasena: 'pedro', foto: '../../assets/usuarios/pedro.png'}
    ]
